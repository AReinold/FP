...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.27]{bilder/the final final plot.png}
...
In der logarithmischen Darstellung wurden die Messwerte unterteilt und zwei lineare Ausgleichsrechnungen durchgeführt, da für die unterschiedlichen Druckbereiche das Saugvermögen nicht konstant ist.
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.28]{bilder/drehexpo.png}
